...
class _HomePageBState extends State<HomePageB> {
            ...
            children: [
              ...
              if (true) ...[
                ...
                Stack(
                  children: [
                    buildEmptyCardView(),
                    buildCardSwiper(context, provider),
                  ],
                ),
              ],
              // if (!displaySwiper) buildEmptyCardView(),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text("< See Next", style: StyleConsts.textPrimary),
                    unswipeButton(controller),
                    const Text("Commit >", style: StyleConsts.textPrimary),
                  ],
                ),
              ),
            ],
  ...
  SizedBox buildCardSwiper(BuildContext context, DataProvider provider) {
    return SizedBox(
